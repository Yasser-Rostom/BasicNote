package com.yasser.memorizewords.ui.adapters;
...
public class CatAdapter extends ListAdapter<Category, CatAdapter.CatViewHolder> {
    mSetOnClickListener mlistener;

    public CatAdapter(@NonNull @NotNull DiffUtil.ItemCallback<Category> diffCallback) {
        super(diffCallback);
    }
  ...
  /* public List<Category> getAllCats()
    ...
    public void setOnItemClickListener (mSetOnClickListener listener)
    {
